...
public final class SavingThrows {
    ...
    private static final Map<CharacterClass, List<Band>> TABLES = Map.of(
            CharacterClass.CLERIC, List.of(
            ...
            CharacterClass.FIGHTER, List.of(
            ...
            CharacterClass.DWARF, demihumanBands(),
            CharacterClass.HALFLING, demihumanBands(),
            CharacterClass.ELF, List.of(
