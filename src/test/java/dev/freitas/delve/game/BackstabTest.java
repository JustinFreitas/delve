...
class BackstabTest {
    ...
    @Test
    void aSurprisedThiefAttackDealsMoreDamageThanAnUnsurprisedOne() {
    ...
    private int firstRoundThiefDamage(long seed, boolean monstersSurprised) {
        ...
        save.getSession().getCombat().setMonstersSurprised(monstersSurprised);
        save.getSession().getCombat().setDistanceFeet(0);
